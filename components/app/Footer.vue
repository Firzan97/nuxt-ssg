  ...
  <div class="bg-gray-900">
    ...
    >
      <div class="grid row-gap-10 mb-8 lg:grid-cols-6">
        ...
        >
          <div>
            <p class="font-medium tracking-wide text-gray-300 uppercase">
              Pages
            </p>
            <ul class="mt-2 space-y-2">
              ...
              <li>
                <a
                  class="cursor-pointer text-gray-500 transition-colors duration-300 hover:text-deep-purple-accent-200"
                  @click="$router.push('/vigilex/security')"
                  >Vigilex</a
                >
              </li>
              <li>
                <a
                  class="cursor-pointer text-gray-500 transition-colors duration-300 hover:text-deep-purple-accent-200"
                  @click="$router.push('/vigilex/thermal-screening')"
                  >Thermal screening</a
                >
              </li>
              <li>
                <a
                  class="cursor-pointer text-gray-500 transition-colors duration-300 hover:text-deep-purple-accent-200"
                  @click="$router.push('/vigilex/sign-up')"
                  >Vigilex Features</a
                >
              </li>
            </ul>
            ...
            <ul class="mt-2 space-y-2">
              <li>
                <a
                  href="/"
                  class="cursor-pointer text-gray-500 transition-colors duration-300 hover:text-deep-purple-accent-200"
                  >Suite 8.01, Menara IGB, Mid Valley City, Kuala Lumpur,
                  Malaysia</a
                >
              </li>
              <li>
      ...
      >
        <p class="text-sm text-gray-500">
          © Copyright 2020 Enlightyx Sdn Bhd. All rights reserved.
        </p>
