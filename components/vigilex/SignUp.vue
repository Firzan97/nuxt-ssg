            ...
            <div class="bg-white rounded shadow-2xl p-7 sm:p-10">
              ...
              <form>
                ...
                <div class="mt-4 mb-2 sm:mb-4">
                  <button
                    type="submit"
                    class="inline-flex items-center justify-center w-full h-12 px-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-indigo-700 hover:bg-indigo-600 focus:shadow-outline focus:outline-none"
                  >
                    Subscribe
                  </button>
                </div>
